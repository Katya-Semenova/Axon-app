...
**Дальше:** Шаг 1 урока — лендинг (бриф JTBD → редизайн секций PROTOTYPE TEASER + FEATURES,
которые пользователю не нравятся → SEO/legal/analytics/PWA) + починка деплоя вживую.
