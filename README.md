...
| `../stack/` | 📚 переносимый AI-стек (библиотека промтов + скиллы) — вынесен из axon-app | [stack](../stack/AGENTS.md) |
| [.claude/](.claude/) | настройки AI-помощника: скиллы, хуки-страховки | [README](.claude/README.md) |
| [scripts/](scripts/) | деплой, security-precheck, git-хуки | комментарии в файлах |
