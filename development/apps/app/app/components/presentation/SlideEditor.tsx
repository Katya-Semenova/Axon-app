...
function SummaryBlock({
  ...
  return (
    <div style={{
      ...
      /* Мягче наполовину: muted разбавлен фоном слайда (просьбы 2026-07-04 —
         «жестковато», затем «ещё светлее на 20%»); работает во всех темах. */
      background: "color-mix(in srgb, var(--slide-muted) 50%, var(--slide-bg, #FBF9F3))",
      ...
      {editing ? (
        <textarea
          ...
          style={{
            width: "100%",
            fontFamily: "var(--slide-font-summary, var(--slide-font-display))",
